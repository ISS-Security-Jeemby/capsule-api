...
describe 'Test GetAllCollaborators service' do
  ...
  it 'HAPPY: should get all collaborators of a letter' do
    collaborators = TimeCapsule::GetLetterCollaborators.call(letter_id: @letter1.id)

    _(collaborators.count).must_equal 1
    _(collaborators[0]).must_equal @account2.username
  end
end
